...
# --------------------------------------------------------
# LCNN
# Written by Qing Wang, Sep, 2016
# --------------------------------------------------------
"""The data layer used during training to train a LCNN network.

LocDataLayer implements a Caffe Python layer.
"""
...
class LocDataLayer(caffe.Layer):
    """Location CNN data layer used for training."""
